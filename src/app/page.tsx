 ...
 * Section hero, compétences, projets en vedette et call-to-action
 * 
 * @author Rayane Laidi
 * @version 2.0
 * @description Landing page principale présentant mon identité,
 * mes compétences clés et une sélection de mes meilleurs projets
 */
...
export default function HomePage() {
  // Sélection des 3 premiers projets à mettre en avant
  const featuredProjects = projects.slice(0, 3);

  return (
    <>
      {/* Section hero - titre principal, sous-titre et boutons d'action */}
      <section
        style={{
          minHeight: "100vh",
          display: "flex",
