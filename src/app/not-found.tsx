 ...
 * Affichée lorsqu'un utilisateur accède à une route inexistante
 * 
 * @author Rayane Laidi
 * @version 2.0
 * @description Page d'erreur 404 avec titre animé,
 * liens utiles et bouton de retour à l'accueil
 */
