 ...
 * Présentation visuelle d'un projet avec gradient, tags et technologies
 * 
 * @author Rayane Laidi
 * @version 2.0
 * @description Carte interactive affichant l'aperçu d'un projet,
 * cliquable pour accéder à la page de détails du projet
 */
    ...
    <Link href={`/project/${project.slug}`} style={{ textDecoration: "none" }}>
      ...
      >
        ...
        >
          ...
          {/* Overlay au survol - effet de transparence */}
          <div
