 ...
 * Gestion de l'état, validation et envoi vers l'API
 * 
 * @author Rayane Laidi
 * @version 2.0
 * @description Formulaire interactif avec validation côté client,
 * envoi vers l'endpoint API /api/contact et affichage des messages
...
export default function ContactForm() {
  ...
  // Envoi des données du formulaire vers l'endpoint API
  ...
  // Styles partagés pour tous les champs de formulaire
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            type="email"
            required
            placeholder="rayanelaidi8@email.com"
