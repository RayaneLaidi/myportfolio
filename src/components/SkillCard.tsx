 ...
 * Affichage visuel des compétences techniques avec description
 * 
 * @author Rayane Laidi
 * @version 2.0
 * @description Carte modulaire utilisée sur la page d'accueil (mode compact)
 * et sur la page À propos (mode détaillé avec technologies)
 */
